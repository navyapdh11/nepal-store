		...
		const nudges: Nudge[] = [
			{
				type: "weather",
				message:
					"☔ Monsoon season is approaching in Kathmandu. Check out our water-repellent LifeWear.",
				confidence: 95,
			},
			{
				type: "behavior",
			...
			},
			{
				type: "urgency",
				message:
					"⚡ High demand for lightweight jackets in your area. Book your size today.",
				confidence: 82,
			},
		];
